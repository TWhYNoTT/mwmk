        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultMarketerDiscount = table.Column<double>(type: "float", nullable: true),
                    ...
                    TotalPurchaseAmount = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalUsagesCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProofPaymentImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeAndFit = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Addition_Formation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Care = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    img = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Size = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Color = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalNumberOfPieces = table.Column<int>(type: "int", nullable: false),
                    NumberOfPiecesAvailable = table.Column<int>(type: "int", nullable: false),
                    CanBeGift = table.Column<bool>(type: "bit", nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                    DataInserted = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncomePeriodID = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderHeaders_IncomePeriods_IncomePeriodID",
                        column: x => x.IncomePeriodID,
                        principalTable: "IncomePeriods",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderHeaders_Marketers_MarketerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_favourite_products_AspNetUsers_applicationUserId",
                        column: x => x.applicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Size = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Color = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductClassification = table.Column<short>(type: "smallint", nullable: true),
                    applicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_favourite_products_applicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHeaders_IncomePeriodID",
                table: "OrderHeaders",
                column: "IncomePeriodID");

            migrationBuilder.CreateIndex(
                name: "IX_OrderHeaders_MarketerId",
                table: "OrderHeaders",
                column: "MarketerId");
